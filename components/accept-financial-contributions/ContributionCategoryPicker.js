  ...
  constructor(props) {
    ...
    this.messages = defineMessages({
      ...
      ourselvesInfo: {
        ...
        defaultMessage:
          'No Fiscal Host. Simply connect your bank account. You will be responsible for accounting, invoices, taxes, admin, payments, and liability.',
      },
      ...
      organizationInfo: {
        ...
        defaultMessage:
          'Use our Organization as Fiscal Host. The Organization will be responsible for accounting, invoices, taxes, admin, payments, and liability.',
      },
    });
  }
                  ...
                  <Box minHeight={50} px={3}>
                    <P color="black.600" textAlign="center" mt={[2, 3]} fontSize={['12px', '14px']}>
                      <FormattedMessage
                        ...
                        defaultMessage="The Fiscal Host will hold the money and take care of accounting, invoices, taxes, admin, payments, and liability. ({moreInfo})"
                        values={{
                          moreInfo: (
